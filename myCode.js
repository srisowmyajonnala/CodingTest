let givenString = {
  "ISBN:9780980200447": {
    ...
    subjects: [
      ...
      { name: "Reading", url: "https://openlibrary.org/subjects/reading" },
    ],
    ...
    links: [
      ...
      { title: "Chapter 2", url: "http://litwinbooks.com/slowreading-ch2.php" },
      {
...
let jsonString = JSON.stringify(givenString);
let parsedString = JSON.parse(jsonString);

let objectFromParsedString = parsedString["ISBN:9780980200447"];
let showTitle = objectFromParsedString.title;
let showNoOfPages = objectFromParsedString.number_of_pages;
let showMediumLinkImage = objectFromParsedString.cover.medium;
console.log(showTitle);
console.log(showNoOfPages);
console.log(showMediumLinkImage);
